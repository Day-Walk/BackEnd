...
public class KafkaPlaceLikeConsumer {
    ...
    @KafkaListener(topics = "save-place-like", groupId = "save-place-like")
    ...
    @KafkaListener(topics = "delete-place-like", groupId = "delete-place-like")
    ...
    @KafkaListener(topics = "bulk-place-like", groupId = "bulk-place-like")
